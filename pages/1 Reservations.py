...
st.set_page_config(page_title="Réservations - Swanky Apartments", layout="wide", page_icon="📅")
...
# ==========================================
# ONGLET PLANNING (vue calendrier / Gantt)
# ==========================================
with tab_planning:
...
with tab_nouvelle:
    ...
    with col1:
        ...
        chambre_data = db.get_chambre(chambre_choisie)
    ...
    if st.button("📌 Créer la réservation", type="primary"):
        ...
        elif not db.chambre_disponible_periode(chambre_choisie, date_arrivee.isoformat(), date_depart.isoformat()):
            st.error(f"⚠️ {chambre_choisie} est déjà réservée sur une partie de cette période. "
